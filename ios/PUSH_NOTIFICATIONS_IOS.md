...
3. **Bundle ID**: debe coincidir con el de Xcode. En este proyecto es `com.example.appFidesoft` (o el que tengas en *Runner* → *Signing & Capabilities*). Si cambias el bundle en Xcode, usa ese mismo en Firebase.
